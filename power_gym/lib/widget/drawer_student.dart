...
class MyDrawerStudent extends StatefulWidget {

  final PageController pageController;

  MyDrawerStudent(this.pageController);

  @override
  _MyDrawerStudentState createState() => _MyDrawerStudentState();
}

class _MyDrawerStudentState extends State<MyDrawerStudent> {
  @override
